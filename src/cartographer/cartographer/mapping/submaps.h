...
/// Converts the given probability to log odds(几率比).
...
/// Converts a probability to a log odds integer. 0 means unknown, [kMinLogOdds, kMaxLogOdds] is mapped to [1, 255].
...
/// An individual submap, which has a 'local_pose' in the local map frame, keeps track of how many range data were
/// inserted into it, and sets 'insertion_finished' when the map no longer changes and is ready for loop closing.
class Submap {
 public:
